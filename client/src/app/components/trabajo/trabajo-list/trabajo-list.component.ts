...
export class TrabajoListComponent implements OnInit {
  ...
  constructor(private trabajoService: TrabajoService, private tiempoService: TiempoService) { }
...
console.log('la lista despues de tiene= '+this.listTiempo)
  ...
  updateTrabajo() {
    ...
    this.trabajoService.updateCodigoOt(this.ot.IdOt, this.ot).subscribe(
      res => {
        console.log(res)
        this.getTrabajos();
      },
